...
class EventsTbl(db.Model):
    ...
    idClient = db.Column(db.Integer, db.ForeignKey('Cliente.idClient'))
    idTypeEvent = db.Column(db.Integer, db.ForeignKey('TypeEvents.idTypeEvent'))
    idAmountPe = db.Column(db.Integer, db.ForeignKey('AmountPeople.idAmountPe'))
    idAdMob = db.Column(db.Integer, db.ForeignKey('AdditionalMob.idAdMob'))
    idAdDec = db.Column(db.Integer, db.ForeignKey('AdditionalDec.idAdDec'))
    idAdAli = db.Column(db.Integer, db.ForeignKey('AdditionalAli.idAdAli'))
    idOtServ = db.Column(db.Integer, db.ForeignKey('OthersServ.idOtServ'))
    idAct = db.Column(db.Integer, db.ForeignKey('est_active.idAct'))
    dateCreateCot = db.Column(db.Date, primary_key=False)
    dateRealizationEvent = db.Column(db.Date, primary_key=False)